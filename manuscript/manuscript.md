...
| Disease | Model | Phenotype | RP month | BP month | Shift vs pre | Amp ratio | Review queue | Stable in sensitivity | Uncertainty-sensitive |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
